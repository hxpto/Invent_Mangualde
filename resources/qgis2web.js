...
map.getView().fit([-877505.164939, 4935657.884384, -838220.394059, 4968339.351517], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Inventário Arbóreo Urbano de Aguiar da Beira</h2>';
        return titleElement;
    })(),
